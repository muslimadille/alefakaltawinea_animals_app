...
class RegisterationApi{
  ...
  Future<MyResponse<UserDataModel>> register(String name,String email,String phone,String password,String confirmPass,{int regionId=1,int stateId=1}) async {
    ...
    if (response != null && response.statusCode == 200) {
      return MyResponse<UserDataModel>.fromJson(
          json.decode(jsonEncode(response.data)));
    } else {
      return MyResponse<UserDataModel>.init(response!.statusCode.toString(),response.statusMessage!, null);
    }
  }
}