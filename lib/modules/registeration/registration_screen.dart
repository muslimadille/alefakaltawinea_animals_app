        ...
        body: SingleChildScrollView(child: Column(
          ...
          children: [
            Container(
                ...
                child: Center(child: Text(tr("register_header"),style: S.h1(color: C.BASE_BLUE),textAlign: TextAlign.center,),)),
            _header(),
            Container(
...
Widget _coditions(){
    return Container(
        ...
        child:Column(
          ...
          children: [
          Row(children: [
            Radio(value: true, groupValue:_accept,toggleable: true,activeColor: C.BASE_BLUE, onChanged: ( val ){
              setState(() {
                _accept=val as bool ;
              });
            }),
          ...
          _showTermsError?Container(
            padding: EdgeInsets.only(left: D.default_20,right: D.default_20),
            child: Text(tr("terms_error"),style: S.h4(color: Colors.red),),):Container()
        ],));
}
  Widget _name(){
    return Container(
    ...
    return Container(
        ...
        child: TextFormField(
          ...
          decoration:  InputDecoration(
              ...
              suffixIcon: IconButton(onPressed: (){
                setState(() {
                  confirmpasswordobsecure?confirmpasswordobsecure=false:confirmpasswordobsecure=true;
                });
              },icon: Icon((confirmpasswordobsecure??false) ? Icons.visibility_off : Icons.visibility,color: Colors.grey,),)
          ),
          keyboardType: TextInputType.text,
  ...
  Widget _registerBtn(){
    return Center(child: InkWell(
      ...
      child: Container(
        ...
        child: Text(tr("create_new_account"),style: S.h2(color: Colors.white),textAlign:TextAlign.center ,),),),);
  }
  Widget _header(){
    return Container(
      padding: EdgeInsets.all(D.default_10),
      color: C.BASE_BLUE,
      child: Center(child: Text(tr("profile_info"),style: S.h1(color: Colors.white),textAlign: TextAlign.center,),),);
  }
  _onRegisterClicked(){
