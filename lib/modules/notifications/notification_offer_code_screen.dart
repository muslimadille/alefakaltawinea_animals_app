...
import '../../utils/my_widgets/animal_cart_widget.dart';
import '../cart/add_cart_screen.dart';
import '../cart/provider/cart_provider.dart';


class NotificationOfferCodeScreen extends StatefulWidget {
  OfferModel offerModel;
  Shop serviceProviderData;
  NotificationOfferCodeScreen(this.serviceProviderData,this.offerModel);
  @override
  _NotificationOfferCodeScreenState createState() => _NotificationOfferCodeScreenState();
}

class _NotificationOfferCodeScreenState extends State<NotificationOfferCodeScreen> {
  ...
  void initState() {
    ...
    cartProvider!.getMyCart(shop_id: widget.serviceProviderData.id!,offer_id: widget.offerModel.id!);
  }
  @override
