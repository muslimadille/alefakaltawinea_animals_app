...
class NotificationOfferDetailsScreen extends StatefulWidget {
  Shop serviceProviderData;
  int index;
  NotificationOfferDetailsScreen(this.serviceProviderData,this.index);

  @override
  _NotificationOfferDetailsScreenState createState() => _NotificationOfferDetailsScreenState();
}

class _NotificationOfferDetailsScreenState extends State<NotificationOfferDetailsScreen> {
  @override
  Widget build(BuildContext context) {
    return BaseScreen(
        showSettings: false,
        showBottomBar: true,
        tag: "NotificationOfferDetailsScreen",
        body: Column(
          children: [
